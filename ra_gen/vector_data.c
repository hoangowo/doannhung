...
/* Do not build these data structures if no interrupts are currently allocated because IAR will have build errors. */
        ...
        {
                        [0] = sci_i2c_txi_isr, /* SCI1 TXI (Transmit data empty) */
            [1] = sci_i2c_tei_isr, /* SCI1 TEI (Transmit end) */
        ...
        {
            [0] = BSP_PRV_VECT_ENUM(EVENT_SCI1_TXI,GROUP0), /* SCI1 TXI (Transmit data empty) */
            [1] = BSP_PRV_VECT_ENUM(EVENT_SCI1_TEI,GROUP1), /* SCI1 TEI (Transmit end) */
            [2] = BSP_PRV_VECT_ENUM(EVENT_ICU_IRQ1,GROUP2), /* ICU IRQ1 (External pin interrupt 1) */
