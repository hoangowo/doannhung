...
#define VECTOR_NUMBER_SCI1_TXI ((IRQn_Type) 0) /* SCI1 TXI (Transmit data empty) */
#define SCI1_TXI_IRQn          ((IRQn_Type) 0) /* SCI1 TXI (Transmit data empty) */
#define VECTOR_NUMBER_SCI1_TEI ((IRQn_Type) 1) /* SCI1 TEI (Transmit end) */
#define SCI1_TEI_IRQn          ((IRQn_Type) 1) /* SCI1 TEI (Transmit end) */
#define VECTOR_NUMBER_ICU_IRQ1 ((IRQn_Type) 2) /* ICU IRQ1 (External pin interrupt 1) */
#define ICU_IRQ1_IRQn          ((IRQn_Type) 2) /* ICU IRQ1 (External pin interrupt 1) */
